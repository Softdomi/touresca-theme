...
function register_contact_info_settings($wp_customize) {
    ...
    $wp_customize->add_setting("start_chat_num", array(
        "default"   => "",
        "transport" => "refresh",
    ));

    $wp_customize->add_control("start_chat_num", array(
        "label"    => __("Start Chat (Add Whats app Number)", "custom_theme"),
        "section"  => "contact_info_settings_section",
        "settings" => "start_chat_num",
        "type"     => "text",
    ));
}
...
// Add Black Friday Settings
function black_friday_customize_register($wp_customize) {
    // Add Section
    $wp_customize->add_section('black_friday_section', array(
        'title'       => __('Black Friday Settings', 'your-theme'),
        'priority'    => 35,
    ));

    // Add Title Setting
    $wp_customize->add_setting('black_friday_title', array(
        'default'    => '',
        'transport'  => 'refresh',
        'sanitize_callback' => 'sanitize_text_field',
    ));
    $wp_customize->add_control('black_friday_title_control', array(
        'label'    => __('Title', 'your-theme'),
        'section'  => 'black_friday_section',
        'settings' => 'black_friday_title',
        'type'     => 'text',
    ));

    // Add Subtitle Setting
    $wp_customize->add_setting('black_friday_subtitle', array(
        'default'    => '',
        'transport'  => 'refresh',
        'sanitize_callback' => 'sanitize_text_field',
    ));
    $wp_customize->add_control('black_friday_subtitle_control', array(
        'label'    => __('Subtitle', 'your-theme'),
        'section'  => 'black_friday_section',
        'settings' => 'black_friday_subtitle',
        'type'     => 'text',
    ));

    // Add Description Setting
    $wp_customize->add_setting('black_friday_description', array(
        'default'    => '',
        'transport'  => 'refresh',
        'sanitize_callback' => 'sanitize_textarea_field',
    ));
    $wp_customize->add_control('black_friday_description_control', array(
        'label'    => __('Description', 'your-theme'),
        'section'  => 'black_friday_section',
        'settings' => 'black_friday_description',
        'type'     => 'textarea',
    ));

    // Button Text 1 & Link 1
    $wp_customize->add_setting('black_friday_btn_text1', array(
        'default'    => '',
        'transport'  => 'refresh',
        'sanitize_callback' => 'sanitize_text_field',
    ));
    $wp_customize->add_control('black_friday_btn_text1_control', array(
        'label'    => __('Button Text 1', 'your-theme'),
        'section'  => 'black_friday_section',
        'settings' => 'black_friday_btn_text1',
        'type'     => 'text',
    ));

    $wp_customize->add_setting('black_friday_btn_link1', array(
        'default'    => '',
        'transport'  => 'refresh',
        'sanitize_callback' => 'esc_url_raw',
    ));
    $wp_customize->add_control('black_friday_btn_link1_control', array(
        'label'    => __('Button Link 1', 'your-theme'),
        'section'  => 'black_friday_section',
        'settings' => 'black_friday_btn_link1',
        'type'     => 'url',
    ));

    // Button Text 2 & Link 2
    $wp_customize->add_setting('black_friday_btn_text2', array(
        'default'    => '',
        'transport'  => 'refresh',
        'sanitize_callback' => 'sanitize_text_field',
    ));
    $wp_customize->add_control('black_friday_btn_text2_control', array(
        'label'    => __('Button Text 2', 'your-theme'),
        'section'  => 'black_friday_section',
        'settings' => 'black_friday_btn_text2',
        'type'     => 'text',
    ));

    $wp_customize->add_setting('black_friday_btn_link2', array(
        'default'    => '',
        'transport'  => 'refresh',
        'sanitize_callback' => 'esc_url_raw',
    ));
    $wp_customize->add_control('black_friday_btn_link2_control', array(
        'label'    => __('Button Link 2', 'your-theme'),
        'section'  => 'black_friday_section',
        'settings' => 'black_friday_btn_link2',
        'type'     => 'url',
    ));
}
add_action('customize_register', 'black_friday_customize_register');
