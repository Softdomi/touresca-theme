                ...
                <div class="card-images">
                    <div class="bg-white rounded-[20px] shadow-[0_2px_8px_rgba(0,0,0,0.08)] overflow-hidden ">
                        <div class="relative">
                            ...
                            <img loading="lazy" src="<?php echo get_template_directory_uri()?>/images/swipe1.jpg" alt="Luxor Temple"
                                class="w-full h-[250px] object-cover"
                                data-images='["<?php echo get_template_directory_uri()?>/images/swipe1.jpg", "<?php echo get_template_directory_uri()?>/images/swipe2.jpg", "<?php echo get_template_directory_uri()?>/images/swipe3.jpg"]'>
                            <!-- Card badges -->
                        ...
                        <div class="p-6">
                            ...
                            <div class="flex justify-between items-center">
                                <div class="flex items-center gap-2">
                                    <img loading="lazy" src="<?php echo get_template_directory_uri()?>/images/icons/dollar.svg" alt="dollar icon" width="20"
                                        height="20">
