            ...
            <div class="bg-[#F9F9F9] p-8 rounded-[20px] shadow-[0_4px_20px_0px_rgba(0,0,0,0.05)]">
                ...
                <form id="contactForm">
                    ...
                    <div class="mb-4">
                        ...
                        <div class="flex">
                            <div class="relative flex-shrink-0">
                                <select name="countryCode" class="appearance-none pl-8 pr-8 py-2 border border-gray-200 rounded-l-lg focus:outline-none focus:border-[#095763] bg-white">
                                    <option value="+20">+20</option>
                                </select>
                                <div class="absolute inset-y-0 left-2 flex items-center pointer-events-none">
                                    <img src="<?php echo get_template_directory_uri() ?>/images/eg.svg" alt="Egypt flag" class="w-5 h-5">
                                </div>
                            </div>
                            <input type="tel" name="phone" placeholder="1234567890" class="w-full px-4 py-2 border border-gray-200 rounded-r-lg focus:outline-none focus:border-[#095763] bg-white border-l-0">
                        </div>
                    </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="relative">
                            <div class="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
                                <img src="<?php echo get_template_directory_uri() ?>/images/de.svg" alt="German flag" class="w-5 h-5">
                            </div>
                            <select name="country" class="w-full pl-10 pr-10 py-2 border border-gray-200 rounded-lg focus:outline-none focus:border-[#095763] bg-white appearance-none">
