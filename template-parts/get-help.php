...
<section class="grid grid-cols-1 gap-4 md:grid-cols-3 my-16 ">
    ...
    <?php for ($i = 1; $i <= 3; $i++): ?>
        ...
        <?php
$whatsapp_number = get_theme_mod("start_chat_num", "");

if (!empty($whatsapp_number)) :
    // Format WhatsApp link
    $whatsapp_link = "https://wa.me/" . preg_replace('/[^0-9]/', '', $whatsapp_number);
?>
  <a href="<?php echo esc_url($whatsapp_link); ?>" target="_blank" class="text-[<?= $_primary ?>] font-medium flex justify-end items-center gap-2 group">
