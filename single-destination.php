...
if ($destination_query->have_posts()) :
    while ($destination_query->have_posts()) : $destination_query->the_post();
        ...
        $destination_title = get_post_meta($post_id, get_the_title(), true);
        $hero_image = get_post_meta($post_id, 'hero_image', true);
        $hero_desc = get_post_meta($post_id, 'hero_desc', true);
        // $destinations_header = get_post_meta($post_id, 'top_destinations_header', true);
        // $destinations_desc = get_post_meta($post_id, 'top_destinations_desc', true);
...
<?php echo esc_html($about_description); ?> </p>
            ...
            <?php get_template_part('/template-parts/destination-trips') ?>
